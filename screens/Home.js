        ...
        <SafeAreaView style={styles.contenedorScroll}>
            <ScrollView contentContainerStyle={styles.scrollContent}>
                <View style={styles.padre}>
                    ...
                    {/* Espacio extra al final para que el contenido no quede tapado por el botón flotante */}
            ...
            {/* Fondo oscuro transparente cuando el menú está abierto (opcional, para cerrar al tocar fuera) */}
            {menuOpen && (
                <TouchableOpacity 
            ...
            {/* Opciones del menú (se muestran solo si menuOpen es true) */}
            {menuOpen && (
                <View style={styles.fabOptionsContainer}>
                    
                    <View style={styles.fabOptionRow}>
                        <View style={styles.fabLabel}>
                            <Text style={styles.fabLabelText}>Cerrar Sesión</Text>
                        </View>
                    ...
                    <View style={styles.fabOptionRow}>
                        <View style={styles.fabLabel}>
                            <Text style={styles.fabLabelText}>Recetas</Text>
                        </View>
                    ...
                    <View style={styles.fabOptionRow}>
                        <View style={styles.fabLabel}>
                            <Text style={styles.fabLabelText}>Scanner</Text>
                        </View>
                    ...
                    <View style={styles.fabOptionRow}>
                        <View style={styles.fabLabel}>
                            <Text style={styles.fabLabelText}>Coach IA</Text>
                        </View>
                        <TouchableOpacity style={[styles.fabSmall, { backgroundColor: '#3498db' }]} onPress={() => navigation.navigate('AvatarChat')}>
                            <Text style={styles.fabIcon}>💬</Text>
                        </TouchableOpacity>
                    </View>
                    ...
                    <View style={styles.fabOptionRow}>
                        <View style={styles.fabLabel}>
                            <Text style={styles.fabLabelText}>Avatar</Text>
                        </View>
...
const styles = StyleSheet.create({
    ...
    // --- NUEVOS ESTILOS PARA EL BOTÓN FLOTANTE (FAB) ---
    overlay: {
        position: 'absolute',
    ...
    fabMain: {
        ...
        height: 60,
        borderRadius: 30,
        backgroundColor: '#2c3e50', // Color oscuro para el botón principal
        justifyContent: 'center',
        alignItems: 'center',
        elevation: 5,
        zIndex: 10, // Asegura que esté arriba
        shadowColor: '#000',
    ...
    fabMainText: {
        ...
        fontSize: 30,
        fontWeight: 'bold',
        marginTop: -2 // Ajuste visual pequeño
    },
    fabOptionsContainer: {
        position: 'absolute',
        bottom: 100, // Empieza más arriba del botón principal
        right: 30,
        alignItems: 'flex-end',
        zIndex: 5,
    },
    fabOptionRow: {
        flexDirection: 'row',
        alignItems: 'center',
        marginBottom: 15, // Espacio entre botones pequeños
    },
    fabSmall: {
        width: 45,
        height: 45,
